return {
    ["dummy"] = L{"Army's Paeon","Shining Fantasia","Herb Pastoral",},
    ["debuffs"] = L{"Carnage Elegy","Pining Nocturne",},
    ["playlist"] = T{
        ["test"] = L{"Adventurer's Dirge","Warding Round","Wind Carol II","Sword Madrigal","Valor Minuet V",},
        ["haste"] = {'Valor Minuet IV', 'Honor March', 'Blade Madrigal', 'Valor Minuet V',  "Victory March"},
        ["haste4"] = L{'Valor Minuet IV', 'Advancing March', 'Valor Minuet V', "Victory March"},
        ["seg"] = L{'Valor Minuet III', 'Honor March', "Valor Minuet IV", 'Victory March', "Valor Minuet V"},
        ["seg4"] = L{'Advancing March ', 'Victory March', "Valor Minuet IV", "Valor Minuet V"},
        ["sortie"] = L{'Blade Madrigal', 'Honor March', 'Valor Minuet III', "Valor Minuet IV", "Valor Minuet V",},
        ["sortie4"] = L{'Blade Madrigal', 'Honor March', "Valor Minuet IV", "Valor Minuet V",},
        ["ambuscade"] = L{'Blade Madrigal', 'Honor March', 'Valor Minuet III', "Valor Minuet IV", "Valor Minuet V",},
        ...
        ["xevioso"] = L{'Valor Minuet IV','Honor March',"Sentinel's Scherzo", 'Valor Minuet V', "Wind Carol II",},
        ...
        ["kalunga"] = L{"Adventurer's Dirge", 'Honor March', 'Valor Minuet IV', 'Valor Minuet V', 'Fire Carol II',},
        ...
        ["ngai"] = L{'Valor Minuet IV','Honor March',"Sentinel's Scherzo", 'Valor Minuet V', 'Water Carol II',},
        --[[BRD: SV Honor March, Minuet x2, Scherzo, Water Carol2 (on MNK WAR)
        Honor March, Scherzo, Minne, Water Carol2, Ballad (on WHM COR BRD) ]]
        ["arebati"] = L{'Valor Minuet III', 'Honor March', 'Valor Minuet IV', 'Valor Minuet V', 'Valor Minuet II',},
        --[[BRD: Minuet x4, Honor March (on everyone else)
          Dirge, Honor March, Ballad, Minne x2 (on PLD)
          COR need Scherzo ]]
        ["ongo"] = L{'Victory March', 'Sage Etude', 'Learned Etude', "Mage's Ballad III", "Mage's Ballad II",},
        --[[BRD: SV Victory March, Ballad x2, INT Etude x2 (on everyone)
        Minne x3, Paeon, Sirvente (on BRD) ]]
        ["bumba"] = L{'Valor Minuet IV',"Sentinel's Scherzo", 'Honor March',  'Valor Minuet V', 'Valor Minuet III',},
        --[[BRD: BRD: SV Scherzo, Honor March, Minuet x3]]

        --NOTE: IF U HAVE SONG Aria of Passion prime horn Loughnashade replaced Minuet
        
        ["cuijatender"] = L{"Sentinel's Scherzo","Victory March","Light Carol II","Valor Minuet V",},
